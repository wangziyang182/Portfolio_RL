...
def add_arguments(parser):
    ...
    parser.add_argument("--num_signal_feature",type=int, default = 4, help = "number of signal axiuliary feature")
    ...
    parser.add_argument("--sigma",type = float, default = 0.05,help = "sigma")
    parser.add_argument("--variance_decay",type = float,default = 5e-2,help = "decay rate")
    ...
    parser.add_argument("--iteration",type = int,default = 150, help = "number of iteration")
    parser.add_argument("--max_train",type = int, default = 100,help = "maximum training per trajectory")
    parser.add_argument("--with_model", action="store_true", help="Continue from previously saved model")

    parser.add_argument("--cs",type = float, default = 0, help="cost of sell")
    parser.add_argument("--cp",type = float, default = 0, help="cost of purchase")
    parser.add_argument("--step_size",type = int, default = 25, help="env rollling step size")
